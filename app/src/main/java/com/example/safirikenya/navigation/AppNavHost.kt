...
import com.example.safirikenya.ui.theme.AddAcount.AddAccountScreen
...
fun AppNavHost(
    ...
    NavHost(
        ...
        composable(ROUT_ADDACCOUNT) {
            AddAccountScreen(navController =  navController)

        }
        composable(ROUT_ACCOUNTVIEWMODEL) {
            AccountViewModelScreen(navController =  navController)
...
@Composable
fun AccountViewModelScreen(navController: NavController) {
